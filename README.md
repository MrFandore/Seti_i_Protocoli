...
## Описание проекта
Проект демонстрирует автоматизацию настройки сетевого оборудования Cisco с использованием библиотеки Netmiko для Python.
Скрипт выполняет подключение к роутеру и коммутатору, сбор конфигурационной информации и управление VLAN.
...
└── Лабораторная работа 3(Метода).docx  # Методические указания
```
